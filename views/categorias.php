                ...
                <div class="  form-group pull-right ">
                    <div class="input-group">
                        <button class="btn btn-primary btn-sm btn-round" data-toggle="modal" data-target="#exampleModal"
                            data-whatever="@mdo"><i class="fa fa-plus" aria-hidden="true"></i> Nueva Categoria</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                ...
                <form action="" id="formulario">
                    <div class="row">
                        <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <select class="form-control form-control-sm" name="id_cate" id="id_cate">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-round btn-sm" data-dismiss="modal"><i
                        class="fa fa-sign-out" aria-hidden="true"></i> Cancelar</button>
