            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-cog" aria-hidden="true"></i> Configuración <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-desktop"></i> Carta <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
